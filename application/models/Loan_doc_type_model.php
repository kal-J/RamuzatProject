<?php
class Loan_doc_type_model extends CI_Model {

public function __construct() {
  $this->load->database();
}

  var $table = 'loan_doc_type';
  ...
  function set(){
    ...
    $insert_data['loan_doc_type'] = $this->input->post('loan_doc_type');
...
public function update() {
  ...
  $data = array(
    'loan_doc_type' => $this->input->post('loan_doc_type'),
