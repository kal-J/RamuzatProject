<?php
class user_income_type_model extends CI_Model {

public function __construct() {
  $this->load->database();
  $this->table = 'user_income_type';
}
  ...
  function set(){
    ...
    $insert_data['income_type'] = $this->input->post('income_type');
...
public function update() {
  ...
  public  function  get_income_type($filter = FALSE){
    $response = array();
    $this->db->select( '*' );
