...
class Loan_reports extends CI_Controller
{
    ...
    public function index($group_loan_id = false)
    {
        ...
        $this->template->content->view('loan_reports/index', $this->data);
        // Publish the template
        $this->template->publish();
    }

    public function written_off($group_loan_id = false)
    {
        $this->load->model('transactionChannel_model');
        $this->load->model("loan_doc_type_model");
        ...
        $this->helpers->dynamic_script_tags($neededjs, $neededcss);
        $this->template->content->view('loan_reports/written_off', $this->data);
        // Publish the template
        $this->template->publish();
    }
    ...
    public function outstanding_balances($group_loan_id = false)
    {
        $this->load->model('transactionChannel_model');
        $this->load->model("loan_doc_type_model");
        ...
        $this->helpers->dynamic_script_tags($neededjs, $neededcss);
        $this->template->content->view('loan_reports/outstanding_balances', $this->data);
        // Publish the template
        $this->template->publish();
    }
    ...
    public function member_loan_history()
    {
        ...
        $neededcss = array("plugins/select2/select2.min.css", "fieldset.css", "1_12_1_jquery-ui.css", "plugins/daterangepicker/daterangepicker-bs3.css", "plugins/select2/select2.min.css");
        $neededjs = array("plugins/select2/select2.full.min.js", "plugins/validate/jquery.validate.min.js", "plugins/daterangepicker/daterangepicker.js", "plugins/highcharts/code/highcharts.js", "plugins/highcharts/code/highcharts-3d.js", "plugins/highcharts/code/modules/exporting.js", "plugins/highcharts/code/modules/export-data.js", "plugins/highcharts/code/modules/series-label.js", "plugins/printjs/print.min.js", "plugins/select2/select2.full.min.js");
        $this->helpers->dynamic_script_tags($neededjs, $neededcss);
        ...
        $this->template->title = $this->data['title'];
        $this->template->content->view('loan_reports/member_loan_history', $this->data);
        // Publish the template
        $this->template->publish();
    }
