...
class Data_loan_import extends CI_Controller {
    ...
    public function index() {
        ...
        $file_name = "plc_member_loans.csv";
    ...
    private function insert_loan_data($loan_data) {
        ...
        $interest_rate = ($loan_data[4] == 16)?$loan_data[4]: ($loan_data[4] *12);
        ...
        if ($loan_data[0] != "" && $loan_data[0] != 'NULL') {
            $single_row = [
                ...
                "approved_installments" => ($loan_data[8] != '')?$loan_data[8]:1,
            ...
            if ($inserted_loan_id) {
                ...
                $loan_state=["Closed"=>10, "Active"=>7, "OTHER"=>4];
                $loan_state_comment=["Closed"=>'Obligations met Loan closed - Data imported', "Active"=>'Loan Dispersed - Data imported',"OTHER"=>'Loan state unknown so considered withrawn-Data imported'];
                $loan_state_details = [
                    "client_loan_id" => $inserted_loan_id,
                ...
                $payment_status=["Closed"=>1, "Active"=>2, "OTHER"=>4];
                ...
                if ($loan_data[3] !='NULL' && $loan_data[3] !=0) {
                ...
                $repayment_schedule_array = [
                        ...
                        "payment_status" => $payment_status[isset($loan_data[20]) ? $loan_data[20] : "OTHER"],
                        "status_id" => 1,
                        "date_created" => $date_created,
                        "created_by" => 1
                    ];
                $this->repayment_schedule_model->set3($repayment_schedule_array);
