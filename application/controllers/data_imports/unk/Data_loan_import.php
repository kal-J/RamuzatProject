...
class Data_loan_import extends CI_Controller {
    ...
    private function insert_loan_data($loan_data) {
        ...
        $amount=$loan_data[3]; // Principal
        $loan_product_id =$loan_data[9];
        ...
        try {
            if ($loan_data[0] != "" && $loan_data[0] != 'NULL') {
                ...
                if ($inserted_loan_id) {
                    ...
                    $r=$interest_rate_per_annum=$interest_rate_per_installment=(intval(2.5)*12)/100; 
