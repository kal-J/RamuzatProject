    ...
    private function insert_transaction_data($transaction,$counter_amount,$counter_date) {  
        $transaction_date = $this->helpers->extract_date_time($transaction[$counter_date],"Y-m-d");
            $trans_row = [
                ...
                "narrative" => strtoupper($transaction[2]." - Savings deposit on - ".$transaction_date." -[ ".$transaction[1]." ]"),
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction($trans_row);
             ...
             $single_row = [
                ...
                "description" => strtoupper($transaction[2]." - Savings deposit on - ".$transaction_date." -[ ".$transaction[1]." ]"),
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
