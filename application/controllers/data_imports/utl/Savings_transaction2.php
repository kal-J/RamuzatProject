 ...
 * @author Reagan
 */
class Savings_transactions2 extends CI_Controller {
    ...
    public function index() {
        ...
        $file_name = "savings_transactions2.csv";
    ...
    private function insert_transaction_data($transaction) {  
        $members = $this->Data_import_model->get_member_id($transaction[0]);
        $member_id = $members['id'];
        $savings = $this->Data_import_model->get_savings_accounts2($member_id);
