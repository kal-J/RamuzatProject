 ...
 * @author Eric
 */
class Data_loan_import_2022 extends CI_Controller {
    ...
    public function index() {
        ...
        $file_name = "rwenzori_loan_data_2022_update.csv";
    ...
    private function insert_loan_data($loan_data) {
       ...
       // repayment date from m/d/y to yyyy-mm-dd.
        ...
        $interest_type =2;
        $interest_rate = $loan_data[8];
        $repayment_made_every=1;
        $installments= 1;

        try {
            if ($loan_data[11] != "" && $loan_data[11] != 'NULL' && $loan_data[11]==1) {
                $single_row = [
                    "member_id" =>  $member_id,
                    "loan_no" => $loan_data[3],
                    "credit_officer_id" => 2, 
