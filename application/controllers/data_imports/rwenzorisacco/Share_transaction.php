 ...
 *
 * @author Reagan modified and Ambrose Ogwang 01/05/2022
 */
class Share_transaction extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $file_name = "rwenzori_shares_2021.csv";
    ...
    private function insert_transaction_data($transaction)
    {
        ...
        $credit =floatval($transaction[6]);
          ...
          foreach($memberID  as $id){
              $DBMemberIDs = $id;
              $whereIds = "share_account.id='".$DBMemberIDs."'";
              $db_member_id = $this->shares_model->get($whereIds);
          foreach($db_member_id as $MatchingMemberID){
              $share_account_id = $MatchingMemberID['id'];
        ...
        $trans_row = [
            ...
            "narrative" =>"Imported Shares balance "." transaction for [ ".$transaction[2]." ]",
            "status_id" => 1,
            "date_created" => time(),
            "created_by" => 1
        ];
        ...
        if (!empty($transaction_data)) {
            ...
            $single_row = [
                ...
                "description" => "RFGC Share as [ ".$transaction_date." ]",
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
