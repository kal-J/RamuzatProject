    ...
    private function insert_loan_data($loan_data) {
        ...
        if ($loan_data[0] != "" && $loan_data[0] != 'NULL') {
            ...
            if ($inserted_loan_id) {
                ...
                $loan_state_details = [
                    "client_loan_id" => $inserted_loan_id,
                    "state_id" => $loan_data[9]=="Active"?10:7,
                    "comment" => $loan_data[9]=="Active"?'Obligations met Loan closed - Data imported':'Loan Disbursed - Data imported',
