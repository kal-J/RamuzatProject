...
/**
 * Description of Share_transaction
 *
 * @author Reagan
 */
class Share_transaction extends CI_Controller {
    ...
    private function insert_share_transaction_data($transaction) {  
            ...
            $trans_row = [
                ...
                "narrative" => "SHARE ACQUISITION [ ".$transaction[1]." ] AS AT 2021-02-28",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction_shares($trans_row);
             ...
             $single_row = [
                ...
                "description" =>"SHARE ACQUISITION [ ".$transaction[1]." ] AS AT 2021-02-28",
                "transaction_date" =>'2021-02-28',
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
