 ...
 *
 * @author REAGAN transposed @ Ambrose Ogwang 2022/03/03.
 */
class Data_all extends CI_Controller {
    ...
    public function __construct() {
       ...
       // $this->member_no="AGP00000";
       
    }

    public function index() {
        $folder = "data_extract".DIRECTORY_SEPARATOR."bwambarasacco".DIRECTORY_SEPARATOR;
        $file_name = "data.csv";
    ...
    private function create_share_accounts($member_id,$savings_account,$customer_data) {
        $data = [
            ...
            "share_account_no" => $customer_data[0],
            "date_created" => time(),
            "created_by" => 1,
            "modified_by" => 1,
   ...
   /*
    private function insert_saving_transaction_data($member_id,$customer_data,$savings_account) {  
        ...
        $credit = $customer_data[8]>0?floatval($customer_data[8]):0;
            ...
            $trans_row = [
                ...
                "narrative" =>"Imported savings balance ". "transaction for [ ".$customer_data[0]." ]",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
                'deposit_product_id' => 1
            ...
            $insert_id=$this->Data_import_model->add_journal_tr($single_row);
             if(!empty($insert_id)){
                ...
                $data[1] = [
                    ...
                    'reference_no' => $transaction_data['transaction_no'],
                    'debit_amount' => $credit,
                    'narrative' => "Imported savings balance "." transaction for [ ".$customer_data[5]." ] made on " . $transaction_date,
                    'account_id' => 27,
                    'status_id' => 1,
    ...
    public function insert_share_transaction_data($member_id,$share_accounts,$customer_data)
    {
        ...
        $transaction_date = "2021-12-31";
        $credit =$customer_data[7]>0?floatval($customer_data[7]):0;
        ...
        $trans_row = [
            ...
            "payment_id" => 2,
            "transaction_date" => $transaction_date,
            "narrative" =>"Imported Shares balance "." transaction for [ ".$customer_data[5]." ]",
            "status_id" => 1,
            "date_created" => time(),
            "created_by" => 1,
