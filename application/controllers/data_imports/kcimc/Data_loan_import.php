...
class Data_loan_import extends CI_Controller {
    ...
    private function insert_loan_data($loan_data) {
        ...
        $date_created = $this->helpers->extract_date_time($loan_data[1]);
        ...
        try {
            if ($loan_data[0] != "" && $loan_data[0] != 'NULL') {
                ...
                if ($inserted_loan_id) {
                    ...
                    //Loan fee addition
                    if (isset($loan_data[12]) && $loan_data[12] !='NULL' && $loan_data[12] !='') {
                        $loan_fee_data = [
                                "client_loan_id" => $inserted_loan_id,
                    ...
                    $r=$interest_rate_per_annum=$interest_rate_per_installment=($loan_data[6]/100); 
