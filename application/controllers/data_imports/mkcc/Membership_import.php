 ...
 * @author Reagan
 */
class Membership_import extends CI_Controller {
    ...
    private function insert_transaction_data($transaction) {  
        $transaction_date = $this->helpers->extract_date_time($transaction[5],"Y-m-d");
            $trans_row = [
                ...
                "narrative" => "ADMISSION FEES [ ".$transaction[3]." ]",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
        ...
        $transaction_data=$this->Data_import_model->add_membership_fees($trans_row);
             ...
             $single_row = [
                ...
                "description" =>"ADMISSION FEES [ ".$transaction[3]." ]",
