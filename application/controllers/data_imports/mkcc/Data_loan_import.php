        ...
        if ($loan_data[0] != "" && $loan_data[0] != 'NULL') {
            ...
            if ($inserted_loan_id) {
               ...
               // add the client's expense
                ...
                $loan_state_details = [
                    "client_loan_id" => $inserted_loan_id,
                    "state_id" => $loan_data[19],
                    "comment" => $loan_data[19]==10?'Obligations met Loan closed - Data imported':'Loan Disbursed - Data imported',
