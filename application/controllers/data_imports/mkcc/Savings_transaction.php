...
class Savings_transaction extends CI_Controller {
    ...
    public function index() {
        ...
        $file_name = "savings_transaction.csv";
    ...
    private function insert_transaction_data($transaction) {  
       $transaction_date = $this->helpers->extract_date_time($loan_data[4],"Y-m-d");
            $trans_row = [
                ...
                "narrative" => "DEPOSIT [ ".$transaction[1]." ]",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction($trans_row);
             ...
             $single_row = [
                ...
                "description" =>"DEPOSIT [ ".$transaction[1]." ]",
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
     ...
     private function insert_transaction_data_W($transaction) {  
       $transaction_date = $this->helpers->extract_date_time($loan_data[4],"Y-m-d");
            $trans_row = [
                ...
                "payment_id" =>1,
                "transaction_date" =>$transaction_date,
                "narrative" => "SAVINGS WITHDRAW [ ".$transaction[1]." ]",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction($trans_row);
             ...
             $single_row = [
                ...
                "ref_id" => $transaction_data['transaction_id'],
                "ref_no" => $transaction_data['transaction_no'],
                "description" =>"SAVINGS WITHDRAW [ ".$transaction[1]." ]",
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
