...
class Data_all extends CI_Controller {
    ...
    private function insert_user_data($customer_data){
        ...
        $date_registered = "2019-12-31";
           
        if ($customer_data[0] != "" && $customer_data[0] != NULL) {
          $names = explode(" ", trim(strtoupper($customer_data[0])));
            $single_row = [
               
                "firstname" => $names[0],
                "lastname" => isset($names[1])?$names[1]:'',
                "othernames" => isset($names[2])?$names[2]:'',
                "gender" => (int)$customer_data[3]==1 ? 1:0,
                "marital_status_id"=>1,
    ...
    public function create_savings_accounts($member_id,$customer_data) {
        ...
        $data = [
            ...
            "account_no" =>strtoupper($customer_data[2]),
            "date_created" => time(),
            "created_by" => 1,
            "modified_by" => 1
        ];
    ...
    private function create_share_accounts($member_id,$customer_data) {
        ...
        $data = [
            ...
            "share_account_no" => strtoupper($customer_data[2]),
            "date_created" => time(),
            "created_by" => 1,
            "modified_by" => 1
