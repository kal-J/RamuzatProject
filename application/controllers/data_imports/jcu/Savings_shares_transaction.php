 ...
 * @author Reagan
 */
class Savings_shares_transaction extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $file_name = "savings_shares_transactions.csv";
    ...
    {
        $transaction_date = $this->helpers->extract_date_time($transaction[6], "Y-m-d");
        //echo $transaction[7]; die();
        //echo $transaction_date; die();

        $transaction_no_row = date('yws') . mt_rand(1000000, 9999999);
        $trans_row = [
            "transaction_no" =>  $transaction_no_row,
        ...
        if ($transaction[5] == 8) {
            ...
            $trans_row1 = [
                ...
                "transaction_date" => $transaction_date,
                "narrative" => $transaction[2],
                "ref_no" => $transaction_no_row,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data1 = $this->Data_import_model->add_transaction($trans_row1);
        }
