...
class Savings_transaction extends CI_Controller {
    ...
    private function insert_transaction_data($transaction) {  
            ...
            $trans_row = [
                ...
                "narrative" => "MEMBERS SAVINGS [ ".$transaction[1]." ] AS AT 2021-06-30",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction($trans_row);
             ...
             $single_row = [
                ...
                "description" =>"MEMBERS SAVINGS [ ".$transaction[1]." ] AS AT 2021-06-30",
    ...
    private function insert_share_transaction_data($transaction) {  
            ...
            $trans_row = [
                ...
                "payment_id" =>2,
                "transaction_date" =>'2021-06-30',
                "narrative" => "SHARE CAPITAL [ ".$transaction[1]." ] AS AT 2021-06-30",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1
            ];
            $transaction_data=$this->Data_import_model->add_transaction_shares($trans_row);
             ...
             $single_row = [
                ...
                "ref_id" => $transaction_data['transaction_id'],
                "ref_no" => $transaction_data['transaction_no'],
                "description" =>"SHARE CAPITAL [ ".$transaction[1]." ] AS AT 2021-06-30",
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
