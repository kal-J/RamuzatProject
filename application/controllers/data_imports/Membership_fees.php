 ...
 * @author Reagan
 */
class Membership_fees extends CI_Controller {
    ...
    public function index() {
        ...
        $file_name = "MEMBERSHIP_FEES1.csv";
    ...
    private function insert_transaction_data($transaction) {  
        $transaction_date = $this->helpers->extract_date_time($transaction[7],"Y-m-d");
            $trans_row = [
                "transaction_no" =>  "M".intval(0).date('yws').mt_rand(1000,9999),
                "member_id" => $transaction[0],
                "amount" => $transaction[5],
                "member_fee_id" => $transaction[4],
                "payment_id" =>1,
                "requiredfee"=>$transaction[6],
