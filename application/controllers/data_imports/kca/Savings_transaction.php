    ...
    private function insert_transaction_data($transaction) {  
        ...
        $credit = floatval($transaction[6]);
            ...
            $trans_row = [
                ...
                "narrative" => $transaction[3]." transaction for [ ".$transaction[2]." ]",
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
                'deposit_product_id' => $transaction[7],
            ];
            ...
            //echo json_encode(($transaction_data)); die;
             ...
             $single_row = [
                ...
                "description" =>$transaction[3]." transaction for [ ".$transaction[2]." ]",
                "transaction_date" =>  $transaction_date,
                "status_id" => 1,
                "date_created" => time(),
                "created_by" => 1,
            ...
            $insert_id=$this->Data_import_model->add_journal_tr($single_row);
             if(!empty($insert_id)){
                ...
                $data[0] = [
                    ...
                    'narrative' => $transaction[3]." transaction for [ ".$transaction[2]." ] made on " . $transaction_date,
                    'account_id' =>8 ,
                    'status_id' => 1
                ];
                $data[1] = [
