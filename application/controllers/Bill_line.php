 ...
 * Bill Line Controller
 *  */
class Bill_line extends CI_Controller {
    ...
    public function jsonlist() {
        $this->data['data'] = $this->bill_line_model->get();
        echo json_encode($this->data);
    }
    public function jsonlist2() {
        //getting transactions for a specific account
        $this->data['data'] = $this->bill_line_model->get2();
        echo json_encode($this->data);
    }
    ...
    function delete() {
        ...
        if (($response['success'] = $this->bill_line_model->delete($bill_line_id)) === true) {
