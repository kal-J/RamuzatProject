<span class="modal inmodal fade" id="print_options_balsheet-modal" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">   
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">Paper</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                        	<input type="text" name="filename" value="Balance Sheet" class="form-control" required />
                        </div>
                    </div>
                </div>
