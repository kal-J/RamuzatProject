            ...
            <div class="ibox-content">
                <div class="tabs-container">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a class="nav-link active" data-bind="click: display_table" data-toggle="tab" href="#tab-receivables"><i class="fa fa-line-chart"></i> Aging Receivables </a>
                        </li>
                        <li><a class="nav-link" data-bind="click: display_table" data-toggle="tab" href="#tab-tabular"><i class="fa fa-line-chart"></i> Debtors </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <table class="table-bordered display compact nowrap table-hover" width="100%">
                                                ...
                                                <tr data-bind="with:aging_invoices">
                        ...
                        <div role="tabpanel" id="tab-tabular" class="tab-pane ">
                            <div class="panel-body"><br>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <table class="table-bordered display compact nowrap table-hover" id="tblAginginvoice" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>Client</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var ReportsModel = function() {
            ...
            self.aging_invoices = ko.observable();
            self.updateData = function() {
                $.ajax({
                    ...
                    url: "<?php echo site_url('reports/aging_receivables') ?>",
                    success: function(response) {

                        self.aging_invoices(response.aging_invoice_receivables);
                        draw_basic_bar_graph("bar_graph3", "Aging Accounts Receivables", "Receivable Amount: <b>{point.y:.1f}</b>", response.aging_receivables);
                    }
                })
            };
        };
        ...
        var handleDataTableButtons = function(tabClicked) {
            <?php $this->view('reports/receivables/aging_invoice_table_js'); ?>
        };
