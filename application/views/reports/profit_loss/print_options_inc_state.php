<span class="modal inmodal fade" id="print_options_inc_state-modal" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                        	<input type="text" name="filename" value="Income Statement" class="form-control" required />
                        </div>
                    </div>
                </div>
