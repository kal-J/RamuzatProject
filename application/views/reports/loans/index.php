            ...
            <div class="ibox-content">
                <div class="tabs-container">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li><a class="nav-link" data-bind="click: display_table" data-toggle="tab" href="#tab-loan_report"><i class="fa"></i> General Report </a>
                        </li>

                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"> Loans</a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link " data-bind="click: display_table" data-toggle="tab" href="#tab-loans"><i class="fa"></i> Active Loans </a></li>

                                <li><a class="nav-link" data-bind="click: display_table" data-toggle="tab" href="#tab-closed_loans"><i class="fa"></i> Closed Loans </a>
                                </li>

                                <li><a class="nav-link" data-bind="click: display_table" data-toggle="tab" href="#tab-inarrears_loans"><i class="fa"></i> In-arrears Loans </a>
                                </li>

                            </ul>
                        </li>

                        <li><a class="nav-link" data-bind="click: display_table" data-toggle="tab" href="#tab-loan_history"><i class="fa"></i> Loan History </a>
                        </li>
                    ...
                    <div class="tab-content">
                        <?php $this->view('reports/loans/active_loan_view_tab'); ?>
