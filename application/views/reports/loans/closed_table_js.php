//Active client loan javascript
         ...
         if ($('#tblClosed_client_loan').length && tabClicked === "tab-closed_loans") {
         ...
         //daterangepicker_initializer();
                if(typeof(dTable['tblClosed_client_loan'])!=='undefined'){
                    ...
                    $("#tab-closed_loans").addClass("active");
                    dTable['tblClosed_client_loan'].ajax.reload(null,true);
                }else{
         dTable['tblClosed_client_loan']= $('#tblClosed_client_loan').DataTable({
            "pageLength": 10,
            "processing": true,
            "serverSide": true,
            "deferRender": true,
            ...
            "ajax":{
             ...
             "data": function(d){
                ...
                d.state_ids = [8,9,10,14];
                d.min_amount =closed_min_amount;
                d.max_amount =closed_max_amount;
                d.product_id =closed_product_id;
                d.loan_type =closed_loan_type;
                d.report =true;
