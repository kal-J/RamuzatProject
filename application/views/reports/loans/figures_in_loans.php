        ...
        <div class="row">
            ...
            <div class="float-right col-lg-9">
                <div class="row">
                    ...
                    <!-- <label class="col-lg-1 col-form-label">Credit officer<span class="text-danger">*</span></label>
                    <div class="col-lg-3 form-group">
                        <select required class="form-control" name="credit_officer_id" id="credit_officer_id" data-bind='options: credit_officers, optionsText: function(data){ return data.firstname+" "+ data.lastname+" "+data.othernames+"-"+ data.staff_no}, optionsCaption: "---select---", optionsAfterRender: setOptionValue("id"), value: credit_officer, event:{ change: $root.updateData}' style="width: 100%">
                        </select>
            ...
            <!-- <div class="col-lg-3">
                <div class="ibox ">
                    <div class="ibox-title">
                        <span class="label label-primary float-right">Applications</span>
                        <h5>Loan Apps</h5>
                    </div>
