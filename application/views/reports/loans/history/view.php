...
<div id="print_header" class="row d-none flex-column align-items-center mx-auto w-100" >
            ...
            <div>
                <table class="table table-sm table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <strong><?php echo $member['client_no']; ?></strong>
                        </td>
                    </tr>
                </table>
            </div>
...
<div class="d-flex justify-content-center">
    <span>No loans Available for this Member</span>
</div>
...
<hr>
        ...
        <h6 class="text-success" style="font-size: large; font-weight: bold;">
            <center><?php echo $loan_detail['loan_no'] . ' AS OF ' . date('jS F, Y'); ?></center>
        </h6>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        <?php
                        if (empty($loan_detail['applied_fees'])) { ?>
                            <tr>
                                <td colspan="3">This loan had no required fees to be paid.</td>
                            </tr>
                            <?php } else {
                            foreach ($loan_detail['applied_fees'] as $applied_fee) {  ?>
                                <tr>
                ...
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        if (empty($loan_detail['loan_collateral'])) { ?>
                            <tr>
                ...
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        <?php
                        if (empty($loan_detail['loan_guarantors'])) { ?>
                            <tr>
                                <td colspan="3">No Guarantor was submitted by the loan applicant </td>
                            </tr>
                            <?php } else {
                            foreach ($loan_detail['loan_guarantors'] as $key => $loan_guarantor) {  ?>
                                <tr>
                                    <td><?php echo $key + 1; ?></td>
                ...
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        <?php
                        if (empty($loan_detail['loan_approvals'])) { ?>
                            <tr>
                                <td colspan="3">No Approval was submitted for this loan applicantion </td>
                            </tr>
                            <?php } else {
                            foreach ($loan_detail['loan_approvals'] as $key => $loan_approval) {  ?>
                                <tr>
                                    <td><?php echo $key + 1; ?></td>
                ...
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        <?php if (empty($loan_detail['repayment_schedules'])) { ?>
                            <tr>
                                <td colspan="6">This loan has no payment schedule yet.</td>
                            </tr>
                            <?php } else {
                            $paidPrincipal = 0;
                            foreach ($loan_detail['repayment_schedules'] as $repayment_schedule) {  ?>
                                <tr>
                                    <?php
                ...
                <table class="table table-sm table-bordered" width="100%">
                    <tbody>
                        ...
                        $paidPrincipal = 0;
                        foreach ($loan_detail['paid_schedules'] as $paid_schedule) {
                            $rows += 1 ?>
                            <tr>
                                <td><?php echo $rows; ?></td>
