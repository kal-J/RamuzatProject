    if ($('#tblBilling_monthly_sms').length && tabClicked === "tab-sms-monthly") {
        if (typeof dTable['tblBilling_monthly_sms'] !== 'undefined') {
            $(".tab-pane").removeClass("active");
            $("#tab-sms-monthly").addClass("active");
            dTable['tblBilling_monthly_sms'].ajax.reload(null, true);
        } else {
            dTable['tblBilling_monthly_sms'] = $('#tblBilling_monthly_sms').DataTable({
                "pageLength": 25,
                "responsive": true,
