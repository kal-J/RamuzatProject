                        ...
                        columns: [     
                            ...
                            {data: 'id', render: function (data, type, full, meta) {
                              ...
                              <?php if(in_array('3', $privileges)){ ?>
                                    display_btn += "<div class='btn-grp'><a href='#add_interest_payment_method_modal' data-toggle='modal' class='btn btn-sm edit_me' title='Savings fees details'><i class='fa fa-edit'></i></a>";
