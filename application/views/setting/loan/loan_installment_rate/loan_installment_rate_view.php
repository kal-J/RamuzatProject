<div class="row">
    <div class="col-lg-12">
        <div class="tabs-container">
            <ul class="nav nav-tabs" role="tablist">
                <li><a class="nav-link active" data-toggle="tab" href="#tab-details"> Branches</a></li>
                <li><a class="nav-link" data-toggle="tab" href="#tab-depts">Departments</a></li>
            </ul>
            <div class="tab-content">
                <div role="tabpanel" id="tab-details" class="tab-pane">
                    <div class="panel-body">
                        <div><strong>Branch Details</strong>    <?php if(in_array('3', $privileges)){ ?><a data-toggle="modal" href="#loan_installment_rate-modal"  data-bind="click: initialize_edit" class="btn btn-sm btn-default pull-right"><i class="fa fa-pencil"></i> Update</a><?php } ?></div>
                ...
                <div role="tabpanel" id="tab-depts" class="tab-pane">
                    <div class="panel-body">                   
    ...
    <?php echo $loan_installment_rate_modal; ?>
...
<script>
    ...
    var BranchDetailModel = function() {
        ...
        self.initialize_edit = function(){
            edit_data(self.branch(),"formLoan_installment_rate");
    }
    };
            ...
            if ($("#tblDepartment").length) {
                dTable['tblDepartment'] = $('#tblDepartment').DataTable({
                    ...
                    columns:[
                        ...
                        { data: 'dept_phone', render:function ( data, type, full, meta ) {return "<a href='tel:"+data+"'>"+data+"</a>";} },
                        { data: 'dept_email', render:function ( data, type, full, meta ) {return "<a href='mailto:"+data+"'>"+data+"</a>";} },
...
function reload_data(form_id, response){
    switch(form_id){
        case "formLoan_installment_rate":
