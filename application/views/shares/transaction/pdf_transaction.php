...
<span colspan="3" style="color:#333;font-size:8; text-align:left;"><?php echo $org['name']; ?><br />
        ...
        <td></td>
        <td></td><td></td>
        <td colspan="3" style="color:#333;font-size:9; text-align:left;">Share Account No: <b><?php echo $share_details['share_account_no']; ?> </b><br /><br />Account Name: <b><?php echo $share_details['member_name']; ?></b> <br /><br />
...
<table border="0" cellspacing="0">
    <tr>
        ...
        <td colspan="6"><b>SHARE ACCOUNT STATEMENT</b></td>
        <td></td>
    </tr><hr />
</table>
<p></p>
        ...
        foreach( $transactions as $trans ){  ?>    
            <tr bgcolor="grey" cellpadding="2">
               <td><?php echo $trans['transaction_no']; ?></td>
                <td><?php echo $trans['share_account_no']; ?></td>
...
<table border="0" cellspacing="2">
    <tr>
         <td colspan="4"><b>Share Account Summary </b> </td>
         <td></td>
         <td></td>
         <td></td>
    </tr><hr>
    ...
    <tr>
        <td >Total amount</td>
        <td ><?php  echo number_format($share_details['total_amount']); ?></td>
    </tr>
