...
<div class="modal inmodal fade" id="buy_shares" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form method="post" enctype="multipart/form-data" class="formValidate" action="<?php echo base_url(); ?>Share_transaction/Create" id="formBuy_shares">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">  
                        <span data-bind="text:'Buy Shares'"></span>
                </h4>
            ...
            <div class="modal-body">
                <div class="">
                    ...
                    <input type="hidden" name="transaction_charge_type_id" id="transaction_charge_type_id" value="11">
                        ...
                        <input type="hidden" class="form-control" name="share_account_no"  data-bind="value:share_account_no" >
                        </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            attr: {'data-rule-min':1,'data-msg-min':'Amount must be greater or equal to '+curr_format(1)}" name="amount" type="text" required>
                            <span class="blueText">Amount must be greater than  <b data-bind="text:1"></b> (Minimum amount).</span>
                            </div>
