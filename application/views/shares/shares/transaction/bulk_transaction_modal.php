              ...
              <div class="form-group row">
                    ...
                    <label class="col-lg-3 col-form-label">Payment Method <span class="text-danger">*</span></label></label>
                        <div class="col-lg-3">
                            ...
                            , optionsText: "payment_mode", optionsCaption: "-- select --" ,optionsAfterRender: setOptionValue("id")!=5,value: $root.payment_mode.id !=5, attr:{name:"payment_id"}' class="form-control"  required > </select>
                        </div>
