<!-- bootstrap modal -->
<div class="modal inmodal fade" id="pay_membership_fees-modal" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
            <form method="post" class="formValidate" action="<?php echo site_url(); ?>applied_member_fees/create" name= "formDetail_member_fees" id="formDetail_member_fees">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-4" data-bind="visible: id !=5">
                            ...
                            optionsAfterRender: setOptionValue("id"), attr:{name:"transaction_channel_id"}, value:$root.trans_channel' 
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                <textarea name="narrative" id="narrative" class="form-control m-b" required="required" 
                                placeholder="Subscription Narrative"></textarea>
                            </div>
                        </div>
                    </div>
                    <!--/ko-->
                ...
                <div class="modal-footer">
                    <?php if ((in_array('1', $member_privilege)) || (in_array('3', $member_privilege))) { ?>
                        <button class="btn btn-primary btn-flat" data-bind="enable:$root.available_member_fees().length > 0" 
                            type="submit">Apply Fees</button>
                    <?php } ?>
                </div>
            </form>
        </div>
