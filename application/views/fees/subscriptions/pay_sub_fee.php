<!-- bootstrap modal -->
<div class="modal inmodal fade" id="pay_sub_fee-modal" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <?php echo form_open_multipart("client_subscription/create", array('id' => 'formClient_subscription', 'class' => 'formValidate', 'name' => 'formClient_subscription', 'method' => 'post', 'role' => 'form')); ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h3 class="modal-title"><?php echo $this->lang->line('cont_subscription');  ?> Payment</h3>
