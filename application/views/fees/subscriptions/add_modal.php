            ...
            <div class="modal-body">
                <div  class="row form-group">
                    <label class="col-lg-2 col-form-label">Member/Client</label>
                     <div class="col-lg-5">
                      <select class="form-control" id="subscription_selects" style="width: 100%" name="client_id" data-bind="options: members, optionsText:function(data){ return ((data.client_no==0)?'':data.client_no+' - ') +data.client_name;}, optionsAfterRender: setOptionValue('id'), optionsCaption: '--select--', value: $root.User">
                      </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <input class="form-control m-b"  data-bind="attr: {value:$root.get_last_subscription_date().next_payment_date}" disabled>
                            <input type="hidden" name="subscription_date" id="subscription_date" class="form-control m-b" required="required" data-bind="attr: {value:$root.get_last_subscription_date().next_payment_date}" readonly>
                        </div>
                    </div>
                    <!--/ko-->
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <input type="text" name="amount" id="amount" class="form-control m-b" data-bind="attr:{value:$root.get_last_subscription_date().amount_payable}" required="required" readonly>
                        </div>
                    </div>
                    <!--/ko-->
                </div>
