<span class="modal inmodal fade" id="printout_options-modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" target="_blank" action="<?php echo site_url("member/print"); ?>" >
            <div class="modal-content">
                ...
                <div class="modal-body">   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                        	<input type="text" name="filename" value="<?php echo $user['firstname']." ".$user['lastname']." ".$user['othernames'];?> BIODATA" class="form-control" required />
                        </div>
                    </div>
                </div>
