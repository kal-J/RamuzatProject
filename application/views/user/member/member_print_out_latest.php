<style type="text/css" media="print">
 ...
 <section id="printable_member_bio_data">
...
<div class="col-lg-12">
    ...
    <table class="table table-sm  table-stripped">
        <tbody>
            <tr style="padding-bottom:10px;">
                ...
                <td style="float:right;margin:0;width:500px">
                <br>
                <?php if($user['photograph'] !=''){?>
                <img id="photo" src="<?php echo base_url('uploads/organisation_'.$_SESSION['organisation_id'].'/user_docs/profile_pics/'.$user['photograph']); ?>" alt="user image" class="img thumbnail" style="width:170px; height:170px;text-align: right;
                display: block;border:solid 1px #1c84c6 ;padding:20px;float:right;">
                 <?php } else { ?>
                <h2 style="border:solid 1px #1c84c6;width:150px; height:150px;line-height:150px;margin:0 auto;text-align:center;float:right" id="photo">Photo</h2>
                 <?php }?>
                </td>
    ...
    <table class="table table-sm table-bordered" width="100%">
            <tbody >
                <tr>
                     <td colspan="2" style="background-color: #1c84c6;">
                        <strong><span style="font-size: 16px; color:#fff;font-weight: bold;"><center><?php echo $user['firstname']." ".$user['lastname'];?></center></span></strong>
                    </td>
                </tr>
         ...
         <table class="table table-sm table-bordered" width="100%">
            <tbody >
                ...
                <tr >
                    ...
                    <th >
                        <span style="font-size: 13px;"><center>Account Balance</center></span>
                    </th>
                     <!-- <th >
