...
<table border="0" cellspacing="0" cellpadding="3"><tr><td class="center"><b>MEMBER FEES PAYMENT RECIEPT</b></td></tr></table>
<table border="0" cellspacing="0" cellpadding="2">
    <tr><td></td>
		<td>Date : <?php echo date('jS F, Y h:m:s', $single_receipt_items[0]['date_created']); ?><br />
...
<br><br>
<table border="0" cellspacing="0" cellpadding="2">
    <tr><td>RECEIVED FROM:</td><td></td><td><?php echo $member['salutation'] . ' ' . $member['firstname'] . ' ' . $member['lastname'] . ' ' . $member['othernames']; ?></td></tr>
</table><hr><br ><br>
