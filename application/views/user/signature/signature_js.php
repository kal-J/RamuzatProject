//  Position javascript 
        ...
        "columns": [
                  ...
                  { "data": "document_name", render:function ( data, type, full, meta ) {
                    var doc_name ="";
                    doc_name += "<a href='<?php echo base_url();?>uploads/organisation_<?php echo $_SESSION['organisation_id'];?>/user_docs/other_docs/"+data+"' class='btn btn-sm btn-default' title='Document preview'>Download <i class='fa fa-download'></i></a>";
                       return doc_name;
                  }},
