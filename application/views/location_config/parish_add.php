<div class="modal inmodal fade" id="myModalParish" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
			  <form class="formValidate" action="<?php echo base_url();?>Parish/Create" id="formParish" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
					<h4 class="modal-title">Parish Form</h4>
				...
				<div class="modal-body">
						 ...
						 <div class="form-group row">
								...
								<div class="form-group row">						
									...
									<div class="col-lg-4">						
										<input class="form-control" name="parish" type="text">
									</div>
								</div>
