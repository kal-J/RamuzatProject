                ...
                <div class="col-md-12 center_col">
                   <img alt="logo" img style="width:95%;"  src="<?php 
                    if (!empty($org['organisation_logo'])) {
                        ...
                        <h1 style="text-align:center;"><i class="fa fa-unlock-alt"></i>&nbsp;&nbsp;&nbsp; Update password </h1>
                        <?php echo $this->session->flashdata('message'); ?>
                        <form id="formLogin" class="m-t" role="form" action="<?php echo site_url("welcome/save_new_password"); ?>" method="post">
