                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="state_id" value="7">
                     ...
                     <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control"  id="share_account_no" name="share_account_no" data-bind="attr: {value:new_account_no, readonly:new_account_no()!==false?'readonly':''}" required/>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 form-group">
                            ...
                            <?php }else{?>
                            <!-- ko if: $root.share_details != undefined -->
                            ...
                            <!-- ko if: ($root.share_details == undefined) && $root.member != undefined -->
                                <input type="text" class="form-control" data-bind="value: $root.member().member_name"
                                     disabled>
                                <input type="hidden" name="member_id" data-bind="value: $root.member().id">
