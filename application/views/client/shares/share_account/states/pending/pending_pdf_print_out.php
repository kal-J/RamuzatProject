<section id="printable_pending_shares">
    ...
    <div>
        <h5 class="text-success my-2">
            <center><b>PENDING SHARE ACCOUNTS</b></center>
        </h5>
    </div>
    ...
    <table cellspacing="2" cellpadding="2" class="table table-sm table-bordered">
        ...
        ?>
            ...
            <tr>
                <td colspan="3">There are no Pending share accounts.</td>
            </tr>
    ...
    <?php if (!empty($data)) { ?>
        <br>
        <div>
            <h5>Pending Share Accounts Summary</h5>
        </div>
        <br>
        ...
        <div>
            <table class="table table-sm table-bordered">
                <tr>
                    <td>Pending Total share Amount</td>
                    <td>
