...
<div class="py-4">
    <?php $this->view('client_loan/states/loan_reports_outstanding_balances/tab_view'); ?>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var handleDataTableButtons = function(tabClicked) {
            <?php $this->view('client_loan/states/loan_reports_outstanding_balances/table_js'); ?>
        };
