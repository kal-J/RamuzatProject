            ...
            <div class="row login-row-container">
                <div class="col-md-6">
                    <div class="ibox-content">
                        ...
                        <h1 style="text-align:center;"><i class="fa fa-unlock-alt"></i>&nbsp;&nbsp;&nbsp; Member Login </h1>
                        <?php echo $this->session->flashdata('message'); ?>
                        <form id="formLogin" class="m-t" role="form" action="<?php echo site_url("welcome/login"); ?>" method="post">
                            ...
                            <!-- <a href="#" class="pull-right">
                             ...
                             <a href="<?php echo site_url("welcome"); ?>" class="pull-left login">
                                <span style="font-weight: bold;">Staff Login? Click here</span>
                            </a>
