//Active client loan javascript 
         ...
         dTable['tblActive_client_loan']= $('#tblActive_client_loan').DataTable({
            ...
            "ajax":{
             ...
             "data": function(d){
              ...
              "footerCallback": function (tfoot, data, start, end, display) {
                    var api = this.api();
                $.each([2,3,4,5,6,8], function(key,val){
                  if(val==8){
            ...
            "columns":[
                  ...
                  return (parseFloat(data) > parseFloat(full.paid_amount))?curr_format( round(((data)-parseFloat(full.paid_amount)) ,2)):curr_format( round(data,2))
                    } },
