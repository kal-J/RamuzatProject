        ...
        <div class="modal-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="text-danger" style=" font-size: 0.9em; font-weight: bold; text-align: center; caption-side: bottom;" class="font-bold" colspan="4">Note: Each installment is after every<span data-bind="text: (approved_repayment_frequency)?' '+approved_repayment_frequency+' '+approved_made_every_name+', ':'None'"></span> the loan's offset is <span data-bind="text: (offset_period)?(offset_period+' '+offset_every+' ' ):''"></span> from the disbursement date [<span data-bind="text: moment($root.action_date(),'DD-MM-YYYY').add(offset_period?offset_period:0,offset_made_every?periods[offset_made_every-1]:'days').format('DD-MM-YYYY')"></span>]</td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              ...
              <select class="form-control" required data-bind='options: $root.transaction_channel, optionsText:function(data_item){return data_item.channel_name}, optionsCaption: "--select--", optionsAfterRender: setOptionValue("linked_account_id"), attr:{name:"source_fund_account_id"}, value:$root.trans_channel' data-msg-required="Fund Source A/C must be selected" style="width: 100%">
              </select>
            </div>
          </div>
