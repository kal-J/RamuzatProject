     ...
     <small class="font-bold">Note: Required fields are marked with <span class="text-danger">*</span></small>
        ...
        <div class="modal-body"><!-- Start of the modal body -->
            ...
            <!-- ko with: loan_details -->
                    ...
                    <input type="hidden" name="phone_number" data-bind="attr:{value: phone_number}">
                    <input type="hidden" name="preferred_payment_id" data-bind="attr:{value: preferred_payment_id}">
                    <input type="hidden" name="member_name" data-bind="attr:{value: member_name}">
                    <input type="hidden" name="payment_mode" data-bind="attr:{value: payment_mode}">
                    ...
                    <div class="form-group row">
                      <div class="table-responsive">
                        <table class="table table-bordered table-hover" >
                          <caption class="text-success" style=" font-size: 1.5em; font-weight: bold; text-align: center; caption-side: top;"> <span data-bind="text:(group_name&&member_name)?group_name+', '+ member_name:(group_name&&!member_name)?group_name:member_name"></span> - Loan Info</caption>
                            <thead>
                                <tr>
                          ...
                          <caption class="text-success" style=" font-size: 1.5em; font-weight: bold; text-align: center; caption-side: top;">Parent Loan Info</caption>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td data-bind="text: curr_format(parseFloat(disbursed_amount)-parseFloat(parent_paid_principal))"></td>
                              </tr>
                            </tbody>
                        </table>
                        <!-- /ko-->
                          ...
                          <div class="input-group date" >
                            ...
                            <input type="hidden" class="form-control" name="amount_approved" data-bind="attr:{value: amount_approved}">
                             <select class="form-control" required
                                data-bind='options: $root.transaction_channel, optionsText:function(data_item){return data_item.channel_name}, optionsCaption: "--select--", optionsAfterRender: setOptionValue("linked_account_id"), attr:{name:"source_fund_account_id"}, value:$root.trans_channel'
                                data-msg-required="Fund Source A/C must be selected" style="width: 100%">
                            </select>
                            </div>
                        </div>          
...
<fieldset class="col-lg-12">
    ...
    <table  class="table table-striped table-condensed table-hover">
        ...
        <tbody data-bind='foreach: $root.available_loan_fees'>
            <tr data-bind="if:parseInt(chargetrigger_id)<=3 || (parseInt(chargetrigger_id)===(parseInt($parent.preferred_payment_id)===1?4:0 || parseInt($parent.preferred_payment_id)===2?5:0 ||parseInt($parent.preferred_payment_id)===7?9:0||parseInt($parent.preferred_payment_id)===6?8:0||parseInt($parent.preferred_payment_id)===8?10:0|| parseInt($parent.preferred_payment_id)===4?6:0))">
                          ...
                          <caption class="text-success" style=" font-size: 1.5em; font-weight: bold; text-align: center; caption-side: top;">Payment Schedule</caption>
                            ...
                            <tfoot data-bind="with: $root.payment_summation">
                              <tr>
                                ...
                                <input type="hidden" data-bind="attr:{name:'principal_value',value: round(principal_amount,0)}"/>
