<div class="modal inmodal fade" id="lock-modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
<div class="modal-dialog modal-lg">
<div class="modal-content">

<form method="post" class="formValidate" action="<?php echo base_url();?>loan_state/lock" id="formLock">
            ...
            <!-- ko with: loan_details -->
                ...
                <div class="form-group row"><!-- start of Requested Amount row -->
                    <div class="col-lg-1"></div>
                        <label class="col-lg-3 col-form-label">Disbursed Amount is</label>
                        <div class="col-lg-6 form-group">
                        <span placeholder="" class="form-control" type="readonly" data-bind="text: 'UGX '+curr_format((amount_approved)*1)"></span>
                        </div>
                    </div>
            <!--/ko--> 
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label">Date of Locking<span class="text-danger">*</span></label>
