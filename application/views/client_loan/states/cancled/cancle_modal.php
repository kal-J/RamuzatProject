<div class="modal inmodal fade" id="cancle-modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
<div class="modal-dialog modal-lg">
<div class="modal-content">

<form method="post" class="formValidate" action="<?php echo base_url();?>loan_state/cancle" id="formCancle">
...
<div class="modal-header">
     ...
     <h4 class="modal-title">
        ...
        if (isset($modalTitle1)) {
            ...
            echo "Canceling Loan Application";
        }
     ?></h4>
          ...
          <div class="modal-body"><!-- Start of the modal body -->
            ...
            <!--/ko--> 
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label">Date of Canceling<span class="text-danger">*</span></label>
                    ...
                    <div class="form-group row"><!-- start of reject note row -->
                        <label class="col-lg-4 col-form-label">Cancel&nbsp;Note<span class="text-danger">*</span></label>
