//Withdrawn client loan javascript 
         if ($('#tblWithdrawn_loan').length && tabClicked === "tab-application_withdraw") {
         ...
         daterangepicker_initializer();
                if(typeof(dTable['tblWithdrawn_loan'])!=='undefined'){
                    ...
                    $("#tab-application_withdraw").addClass("active");
                    dTable['tblWithdrawn_loan'].ajax.reload(null,true);
                }else{
         dTable['tblWithdrawn_loan']= $('#tblWithdrawn_loan').DataTable({
            "pageLength": 10,
            "processing": true,
            "serverSide": true,
            "deferRender": true,
