<div class="modal inmodal fade" id="application_withdraw-modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
<div class="modal-dialog modal-lg">
<div class="modal-content">

<form method="post" class="formValidate" action="<?php echo base_url();?>loan_state/application_withdraw" id="formApplication_withdraw">
...
<div class="modal-header">
     ...
     <h4 class="modal-title">
        ...
        if (isset($modalTitle1)) {
            ...
            echo "Withdrawing Loan Application";
        }
     ?></h4>
          ...
          <div class="modal-body"><!-- Start of the modal body -->
            ...
            <!--/ko--> 
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label">Date of Application withdraw<span class="text-danger">*</span></label>
