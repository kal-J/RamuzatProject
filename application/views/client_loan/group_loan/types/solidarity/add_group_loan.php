            ...
            <form method="post" class="formValidate" action="<?php if (isset($case2) && $case2 == 'client_loan') {
                ...
                <div class="modal-body">
                    ...
                    <fieldset class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <?php if ((isset($case2) && $case2 != 'group_loan') && ($type == 'client_loan' || (isset($case2) && $case2 == 'client_loan'))) : ?>
                                ...
                                <div class="col-lg-4 form-group">
                                    <select class="form-control" id="member_id" name="member_id" data-bind='options: member_names, optionsText: function(item){ return item.member_name+"-"+item.client_no;}, optionsCaption: "---select---", optionsAfterRender: setOptionValue("id"), value: member_name' required data-msg-required="Member is required" style="width: 100%">
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4 form-group">
                                <div class="input-group date" data-date-start-date="<?php echo isset($active_month) ? date('d-m-Y', strtotime($active_month['month_start'])) : date('d-m-Y', strtotime($fiscal_active['start_date'])); ?>" data-date-end-date="<?php echo isset($active_month) ? ((strtotime(date('d-m-Y')) < (strtotime($active_month['month_end']))) ? date('d-m-Y') : date('d-m-Y', strtotime($active_month['month_end']))) : ((strtotime(date('d-m-Y')) < (strtotime($fiscal_active['end_date']))) ? date('d-m-Y') : date('d-m-Y', strtotime($fiscal_active['end_date']))); ?>">
                                    <input class="form-control" onkeydown="return false" autocomplete="off" required name="action_date" data-bind="datepicker: $root.application_date,attr:{value:$root.application_date}" type="text"><span data-bind="datepicker: $root.application_date" class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 form-group">
                                <select class="form-control" id="loan_product_id" name="loan_product_id" data-bind='options: product_names, optionsText: "product_name", optionsCaption: "---select---", optionsAfterRender: setOptionValue("id"), value: product_name' required data-msg-required="Loan Product is required" style="width: 100%">
                                </select>
                            </div>
                            <label class="col-lg-2 col-form-label">Credit officer<span class="text-danger">*</span></label>
                            <div class="col-lg-4 form-group">
                                <select required class="form-control" name="credit_officer_id" id="credit_officer_id" style="width: 100%">
                                    <option value="">--select--</option>
                                    <?php
                    ...
                    <fieldset class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select class="form-control" name="offset_made_every" data-bind='options: $root.repayment_made_every_detail, optionsText: "made_every_name", optionsCaption: "---select---", optionsAfterRender: setOptionValue("id"),optionsValue:"id", value: $root.product_name().offset_made_every' required data-msg-required="This field is required">
                                </select>
                            </div>
                        </div>
                        <!--/row -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <input class="form-control" type="number" id="paid_every" min="0" step="1" name="repayment_frequency" data-rule-mustbelessthanProductMaxLoanPeriod data-bind="value:repayment_frequency" required>
                            </div>
                            <div class="col-lg-3">
                                <select data-rule-mustbelessthanProductMaxLoanPeriod class="form-control" name="repayment_made_every" id="period_id" data-bind='options: $root.repayment_made_every_detail, optionsText: "made_every_name", optionsCaption: "---select---", optionsAfterRender: setOptionValue("id"),optionsValue:"id", value: $root.product_name().repayment_made_every' required data-msg-required="This field is required">
                                </select>
                            </div>
                        </div>
                        <!--/row -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 form-group">
                            <textarea class="form-control" rows="3" required name="loan_purpose"></textarea>
                        </div>
