<div class="modal inmodal fade" id="add_monthly_expense-modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
<div class="modal-dialog modal-lg">
<div class="modal-content">
<form method="post" class="formValidate" action="<?php echo site_url();?>Client_loan_monthly_expense/create" id="formClient_loan_monthly_expense">
 ...
 <small class="font-bold">Note: Required fields are marked with <span class="text-danger">*</span></small>
            ...
            <div class="modal-body">
                ...
                <div class="row form-group">
                    <label class="col-lg-4 col-form-label">Expense</label>
                    <div class="col-lg-8">
                        <div class="input-group">
                            <select name="expense_id" data-bind='options: $root.expense_items, optionsText: function(item){return item.expense_type},  
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-8">
                        <div class="input-group">
                            <textarea name="description" id="description" class="form-control m-b" required="required" placeholder="Expense Narrative"></textarea>
                        </div>
                    </div>
                </div>
            </div>
