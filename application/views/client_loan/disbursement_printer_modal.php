<span class="modal inmodal fade" id="disbursement_printer-modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" target="_blank" action="<?php echo site_url("loan_approval/pdf_disburse"); ?>" >
            <div class="modal-content">
                ...
                <div class="modal-body">   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                        	<input type="text" name="filename" class="form-control" data-bind="attr:{'value': $root.loan_detail().loan_no+' Disbursement Sheet'}" required />
                        </div>
                    </div>
                </div>
