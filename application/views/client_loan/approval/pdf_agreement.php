<section id="printable_client_loan_agreement">
...
<div class="row d-flex flex-column justify-content-center " style="font-size: small;padding-left: 10px;">
    ...
    <div>
        <h5 class="text-success my-2">
            <center><small><?php echo $loan_detail['loan_no']; ?>-</small> Loan Agreement</center>
            </center>
        </h5>
    </div>
    ...
    <div>
        <table class="table border-0" style="border: none;" cellspacing="0">
            <tr>
                <td>I <span class="blueText"><b><?php echo $loan_detail['member_name']; ?></b></span> acknowledge and agree to approve Ugx. <b> <?php echo number_format($loan_detail['amount_approved']); ?> </b> (<?php echo ucfirst(convert_number_to_words(round($loan_detail['amount_approved'], 0))); ?> Shillings only) as a loan extended to me,
                    that I MUST pay back as per the Loan payment schedule.
                </td><br>
            </tr>
        </table>
    </div>
    ...
    <div>
        <table class="table border-0" style="border: none;" cellspacing="0">
            ...
            <tr>
                <td colspan="2">For <span class="my-1" style="font-size: 16px; text-align:left;"><?php echo $org['name']; ?>
        </span></td>
        <td></td>
