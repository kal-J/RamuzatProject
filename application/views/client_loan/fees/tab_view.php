<div role="tabpanel" id="tab-loan_fee" class="tab-pane">
  <div class="panel-body">
    <div>
      <h3>Applied fees</h3><?php if (isset($loan_detail)) {
                              if (in_array('1', $client_loan_privilege)) { ?><a data-toggle="modal" href="#apply_loan_fee-modal" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus-circle"></i> Attach Fee(s)</a><?php }
                                                                                                                                                                                                                                                      } ?>
    </div>
