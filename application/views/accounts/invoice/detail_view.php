<div class="panel-body">
    ...
    <table class="table table-stripped  m-t-md">
        <tbody data-bind="with: invoice_detail">
            <tr>
                <td>
                    <i class="fa fa-houzz text-navy"></i> Invoice REF
                </td>
                <td data-bind="text: ref_no" class="text-muted">
                </td>
                <td class="no-borders">
                    <i class="fa fa-briefcase text-navy"></i>Debtor Account:
                </td>
                <td class="text-muted">
                    <a title='Click to view account details' data-bind='attr: {href:"<?php echo site_url("accounts/view");?>/" +receivable_account_id}, text: "["+account_code+ "]  "+account_name'></a>
                </td>
            </tr>
            <tr>
                <td class="no-borders">
            ...
            <tr>
                <td class="no-borders">
                    <i class="fa fa-calendar text-navy"></i> Date Invoiced
                </td>
                <td class="text-muted" data-bind="text: moment(invoice_date, 'YYYY-MM-DD').format('D-MMM-YYYY')">
                </td>
                <td class="no-borders">
            ...
            <tr>
                <td class="no-borders">
                    <i class="fa fa-money text-navy"></i>Invoice Amount:
                </td>
