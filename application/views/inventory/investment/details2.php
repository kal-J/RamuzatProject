            ...
            <div class="ibox-content">
                <div class="tabs-container">  
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a class="nav-link active" data-toggle="tab" data-bind="click: display_table"  href="#tab-investment"><i class="fa fa-money"></i>Investment</a></li>
                    </ul>
                    <div class="hr-line-dashed"></div>
                    <div class="tab-content">
                        <?php //$this->view('inventory/fixed_asset/investment/tab_view'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var handleDataTableButtons = function (tabClicked) {
          <?php $this->view('investment/table_js'); ?>
        };
