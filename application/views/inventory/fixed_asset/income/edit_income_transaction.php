<div class="modal inmodal fade" id="edit_transaction-modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <form method="post" class="formValidate" action="<?php echo site_url("asset_income/edit_transaction"); ?>" id="formAsset_income">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="journal_type_id" value="14" />
