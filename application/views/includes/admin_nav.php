        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <img alt="image" style="max-height:90px;" class="rounded-circle" src="<?php
            ...
            if (in_array('4', $modules)) { ?>
                <li class="<?php echo ($this->uri->segment(1) == 'client_loan') ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <?php if (in_array('11', $modules)) { ?>
                            <!--<li>-->
                            <!--    <a href="<?php // echo site_url("loan_reversal"); 
                                                ?>"><i class="fa fa-cubes"></i> <span class="nav-label">Loan Reversals</span></a>-->
                            <!--</li>-->
                        <?php } ?>
                    </ul>
                </li>
                ...
                <li class="<?php echo ($this->uri->segment(1) == 'loan_reports' || $this->uri->segment(1) == 'portfolio_aging') ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li>
                            <a href="<?php echo site_url("loan_reports/loan_book"); ?>"><i class="fa fa-line-chart"></i> <span class="nav-label">Loan Performance</span></a>
                        </li>
            ...
            <?php }
            if ((in_array('2', $modules)) && (in_array('13', $modules))) { ?>
            ...
            if (in_array('10', $modules)) { ?>
                <li class="<?php echo ($this->uri->segment(1) == 'reports') ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <!--  <li>
                                    <a href="<?php //echo site_url("reports/payables"); 
                                                ?>"><i class="fa fa-line-chart"></i> <span class="nav-label">Aging Payables</span></a>
                                </li> -->
            ...
            <?php }
            if ((in_array('11', $modules)) && ($_SESSION['mystatus'] == 9)) { ?>
    ...
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="col-md-12 navbar-header">
                ...
                <div class="row wrapper white-bg page-heading" style="min-width:600px;padding-top:5px; padding-bottom:10px;">

                    <div class="col-md-12 col-sm-12" style="padding-top:5px; text-align: center !important;">
                        <a href="#modalSearch" data-toggle="modal" data-target="#modalSearch">
                            <span id="searchGlyph" class="glyphicon glyphicon-search"></span> <span class="hidden-sm hidden-md hidden-lg">Search <?php echo $this->lang->line('cont_client_name'); ?></span>
                        </a>
                    </div>
            ...
            <div class="col-12 d-flex justify-content-end align-items-center">
                ...
                <button type="button" class="btn btn-dark rounded ml-2 my-2 py-auto">
                SMS CREDIT <span class="badge badge-light">UGX 5,000,000</span>
                </button>
            </div>
        ...
        <?php if ($data['active_year']['close_status'] == 0) { ?>
            <div class="label label-warning" style="width: 100%;">
                <center><b>You are now browsing a closed Financial year. </b> &nbsp; &nbsp;&nbsp; New entries are not recommended</center>
            </div>
        <?php } else if ($data['active_year']['end_date'] < date('Y-m-d')) { ?>
            <div class="label label-danger" style="width: 100%;">
                <center><b>Your financial year End Date has passed, </b> &nbsp; &nbsp;&nbsp; <a href="<?php echo site_url("accounts"); ?>" class="btn btn-xs btn-flat btn-success">Close the Financial Year</a></center>
            </div>
        <?php } else {
        } ?>
        <!-- //=================NOTIFICATION======================== -->
