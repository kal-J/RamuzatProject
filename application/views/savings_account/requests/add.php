...
<div class="modal inmodal fade" id="accept_withdraw-1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
           <!-- <pre data-bind="text: JSON.stringify(ko.toJS($root.accountw), null, 2)"></pre> -->

            <form method="post" class="formValidate" enctype="multipart/form-data" action="<?php echo base_url(); ?>Transaction/Create" id="formWithdraw_requests" name="formWithdraw_requests">
