                                ...
                                <div class="form-group border-bottom" data-bind="if: client_type==2"> 
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 form-group"> 
                                            <select required class="form-control " style="width: 100%" name="group_member_id" data-bind="options: $root.group_members, optionsText: 'member_name', optionsAfterRender: setOptionValue('id'), optionsCaption: '--select--', value: $root.member_nm"> 
                                            </select> 
