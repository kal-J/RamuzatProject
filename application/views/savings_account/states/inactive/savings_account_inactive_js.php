if ($("#tblSavings_account_inactive").length && tabClicked === "tab-inactive_accounts") {
        if (typeof (dTable['tblSavings_account_inactive']) !== 'undefined') {
            $(".savings").removeClass("active");
            $("#tab-inactive_accounts").addClass("active");
            $("#tab-savings").addClass("active");
            dTable['tblSavings_account_inactive'].ajax.reload(null, true);
        } else {
            dTable['tblSavings_account_inactive'] = $('#tblSavings_account_inactive').DataTable({
                ...
                buttons: <?php if(in_array('6', $savings_privilege)){ ?> getBtnConfig('Inactive savings account'), <?php } else { echo "[],"; } ?>
                responsive: true
            });
        }
    }