<div class="modal inmodal fade" id="reverse-modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <form method="post" class="formValidate" action="<?php echo site_url("Transaction/reverse_transaction"); ?>" id="formReverseTransaction">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="transaction_type_id" />
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                        <?php if ((in_array('1', $savings_privilege)) || (in_array('3', $savings_privilege))) { ?>
