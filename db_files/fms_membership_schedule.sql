...
--
-- Table structure for table `fms_membership_schedule`
--

CREATE TABLE `fms_membership_schedule` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `fms_membership_schedule`
--
ALTER TABLE `fms_membership_schedule`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fms_membership_schedule`
--
ALTER TABLE `fms_membership_schedule`
